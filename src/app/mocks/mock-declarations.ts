...
// <<<<<<< detail-view-declaration
//   { id: 0, description: 'Gasoline', amount: 120, date: new Date().toISOString(),
//     empId: 1, status: StatusEnum.SUBMITTED, category: 'hotel', files: [], bankNum: 'NL29ING0DONTHACKMELOLZ'},

//   { id: 1, description: 'Food for good', amount: 10, date: '1-1-2019', empId: 1,
